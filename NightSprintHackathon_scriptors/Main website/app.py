...
app.config['SQLALCHEMY_BINDS'] = {"contlogin" : "sqlite:///contlogindb.db",
                                  "jobs" : "sqlite:///jobsdb.db",
                                  "fill_form" : "sqlite:///fill_formdb.db"}
db = SQLAlchemy(app)
